...
Note that although it does write a `.gitignore` file, it doesn't initialise the git repository, either locally or on github. For that, you can call `usethis::use_git()` and `usethis::use_github()`.
